          ...
          >
            <div class="basicstyle">
                ...
                <div class="itemStyle typeNumber">
                    ...
                    <p class="tishi">当前题量共{{dialogData.formData.totalNum}}题，总分共计{{}}分</p>
                     <el-form-item label="单选题" prop="aloneOptionNum" required>
                         <!-- <template v-slot:header>
                            ...
                            <p class="wargingMsg">（题库共{{}}题，每题3分）</p>
                        </el-form-item>
                        <el-form-item label="多选题" prop="moreOptionsNum" required>
                            <el-input-number :disabled="dialogData.props.title === '查看'"
                                            ...
                                            :step="5" @change="addQuestions()"/>
                            <p class="wargingMsg"> （题库共{{}}题，每题5分）</p>
                        </el-form-item>
                        <el-form-item label="判断题" prop="judgeNum" required>
                            <el-input-number :disabled="dialogData.props.title === '查看'"
                                            ...
                                            :step="5" @change="addQuestions()"/>
                            <p class="wargingMsg">（题库共{{}}题，每题2分）</p>
                        </el-form-item>
                </div>
                <div class="itemStyle typeNumber">
                    <p class="titleName">评定标准</p>
                     <p class="tishi">当前总分共{{dialogData.formData.totalNum}}分，评定标准为总分的百分比{{}}分</p>
                     <el-form-item label="优秀" prop="gradesSum" required>
                         <span> >= </span>&nbsp;&nbsp;
                             <el-input v-model="input2" placeholder="百分比">
                                <template #append>%</template>
                            </el-input>
                     </el-form-item>
                    <el-form-item label="及格" prop="gradesSum" required>
                         <span> >= </span>&nbsp;&nbsp;
                             <el-input v-model="input2" placeholder="百分比">
                                <template #append>%</template>
                            </el-input>
                ...
                <!-- <el-form-item label="试卷总分（分）" prop="gradesSum" required>
                    <el-input
                    type="number"
                    :disabled="dialogData.props.title === '查看'"
                    placeholder="请输入试卷总分"
                    v-model="dialogData.formData.gradesSum"
                    @change="addQuestions"
                    />
                </el-form-item>
                <el-form-item label="及格线（分）" prop="passCriteria" required>
                    <el-input
                    type="number"
                    :disabled="dialogData.props.title === '查看'"
                    placeholder="请输入及格线"
                ...
                <p>当前选择题数{{dialogData.formData.totalNum}}题,平均每题{{dialogData.formData.averageScore}}分</p> -->
            </div>
          </el-form>
        </div>
      </div>
